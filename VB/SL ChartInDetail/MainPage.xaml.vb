...
Namespace SL_ChartInDetail
	Partial Public Class MainPage
		...
		Private Sub Button_Click(ByVal sender As Object, ByVal e As RoutedEventArgs)
			...
			dataControlDetail.ContentTemplate = CType(Me.Resources("ContentDetail"), DataTemplate)

			Dim contentDetail As New ContentDetailDescriptor()
			contentDetail.ContentTemplate = CType(Me.Resources("ContentDetail"), DataTemplate)
			contentDetail.HeaderContentTemplate = CType(Me.Resources("ContentDetail"), DataTemplate)
